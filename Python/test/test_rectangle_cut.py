...
class TestRectangle(TestCase):
    def test_check_side(self):
        ...
        factory.CreatePolygon("rectangle_input.txt")

        editingP = polygon_edit.PolygonEdit(factory)

        try:
            self.assertEqual(factory.GetPolygon().number_vertices, 4)
    ...
    def test_cut_polygon(self):
        ...
        check_list = [
            [d.Point(1.0, 1.0),
             d.Point(1.777777777, 1.0),
             d.Point(2.0, 1.2),
             d.Point(4.0, 3.0),
             d.Point(4.111111111, 3.1),
             d.Point(1.0, 3.1)],
    ...
    def test_viewer(self):
        ...
        viewer.view_polygon("view_rectangle.m")