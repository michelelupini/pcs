#ifndef __TEST_STAR_H
#define __TEST_STAR_H
...
namespace TriangleCutTesting {
  ...
  TEST(TestConvexCutter, TestCook)
  {
    GeometryFactory factory = GeometryFactory("star.txt");
    ...
    */
    try
    {
      ...
      */
      EXPECT_EQ(factory.GetPolygon().NumberVertices, 4);
    ...
    */
    ...
    try
    {
        EXPECT_EQ(factory.GetPointsNumber(), 6);
